    ...
    def printInfo(self):
        ...
        with open(filePathDb,'rb') as input:
            ...
            for i in range(0,lenTmp):
                ...
                print "*Snow Observations Database Host:    " + dbTmp.snowDbHost[i]
                print "*Snow Observations DB Username:      " + dbTmp.snowDbUser[i]
                ...
                print "*Snow Network Subset File:           " + dbTmp.snowNetSubFile[i]
